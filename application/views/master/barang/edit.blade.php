        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ site_url('master/barang/edit_process') }}" method="POST">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input type="text" name="barang_kd" class="form-control"
                                                    placeholder="Isian kode barang..." value="{{ $result['barang_kd'] }}">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input type="text" name="barang_nm" class="form-control"
                                                    placeholder="Isian nama barang..." value="{{ $result['barang_nm'] }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" id="formatnumber" name="harga" class="form-control"
                                                    placeholder="Isian harga..." value="{{ number_format($result['harga']) }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input type="text" name="satuan" class="form-control"
                                                    placeholder="Isian Satuan..." value="{{ $result['satuan'] }}">
                                            </div>
                                        </div>
                                    </div>
                                    <label>Status </label>
