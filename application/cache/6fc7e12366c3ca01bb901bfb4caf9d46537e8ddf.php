...
<?php echo $__env->make('template/top', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('template/sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('template/content', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
