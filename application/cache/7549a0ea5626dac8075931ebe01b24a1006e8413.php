            ...
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(site_url('sistem/group')); ?>"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <div class="text-right">
                                <a href="<?php echo e(site_url('sistem/group')); ?>" type="submit"
                                    class="btn btn-primary">Kembali</a>
                            </div>
                        </div>
                    </div>
                    <form action="<?php echo e(site_url('sistem/group/edit_process')); ?>" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input type="text" value="<?php echo e($result['group_name']); ?>" name="group_name"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <textarea rows="2" class="col-sm-12" name="group_desc"
                                                    placeholder="Deskripsi role..."><?php echo e($result['group_desc']); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
